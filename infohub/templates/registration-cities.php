<?php /* Template Name:  Infohub Cities Registration */ ?>
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  ...
                  <div class="infohub-form-container-blue">
                    ...
                    <?php echo do_shortcode('[contact-form-7 id="ee24793" registration-id="'.hashThis().'" title="Registration Cities - EN"]');?>
                ...
                <center>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 col-md-4">
                      ...
                      <a href="<?php print home_url();?>/infohub-ar/registration/cities?lang=confirmed" class="btn btn-primary btn-blue w-100 fnt-20">Arabic</a>

                    </div>

                    <div class="col-6 col-md-4">

                      <a href="<?php print home_url();?>/infohub/registration/cities?lang=confirmed" class="btn btn-primary btn-blue w-100 fnt-20">English</a>
              ...
              <div class="row">
                ...
                <div class="col-md-8 ">
                  ...
                  <center>
                    ...
                    <p class="fnt-dark-gray fnt-20"> ملاحظة إن المعلومات المقدمة إلى البوابة يجب أن تقدم من قِ;بل ممثلين مخولين نيابة عن منظماتهم فقط </p>
                    ...
                    <div class="form-check mi6-w-50">
                      ...
                      <label class="form-check-label fnt-20 fnt-dark-gray pd-margin" for="flexCheckDefault">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  ...
                  <div class="infohub-form-container-blue">
                    ...
                    <?php echo do_shortcode('[contact-form-7 id="b016c46" registration-id="'.hashThis().'" title="Registration Cities - AR"]');?>
