...
/** results for project return */

function returnpubresults($currentid){
	...
	foreach ($query as $row) {
	   ...
	   $namear =  get_field("title_ar", $postId);
		...
		$arrayitem=array( 
			...
			'name_ar' => empty($namear) ? $title : $namear,
			'postid' => $postId
		);
	                    ...
	                    <div class="col-md-7">
	                        ...
	                        <div class="row infohub-accordion-details">
	                            ...
	                            <div class="col-md-5">
	                                ...
	                                <p class="remMar"><b>' . forceTranslate("Organization Name", "اسم المنظمة") . ':</b></p>
	                                <p class="fnt-15 remMar"><small>(' . forceTranslate("that authored / published the document", "التي قامت بتأليف / نشر المنشور ") . ')</small></p>
	                            </div>
	                        ...
	                        <div class="row infohub-accordion-details">
	                            ...
	                            <div class="col-md-7">' . $row['lang_version'] . '</div>
          		      			...
          		      			<div class="row infohub-accordion-details">
							      				...
							      				<div class="col-md-7">' . $row['pubYear'] . '</div>

							      			</div>

											  <div class="row infohub-accordion-details">

											  <div class="col-md-5"><b>' . forceTranslate("Publication Type", "  نوع المنشور:") . ':</b></div>
				  
											  <div class="col-md-7">' . $row['pubType'] . '</div>
